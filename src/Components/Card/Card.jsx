const Card = ({ card }) => {
  ...
  return (
    <div className="card h-[450px] bg-base-100 shadow-xl">
      <figure>
        <img className="w-full h-44" src={img} />
      </figure>
      <div className="card-body p-3 text-center">
        <h2 className="card-title">{name}</h2>
        <p className="text-justify my-1">{details} </p>
        <p>
        ...
        <button className="btn btn-primary w-full bg-[#2F80ED] text-white block my-2">
          Select
        </button>
      </div>
    </div>
